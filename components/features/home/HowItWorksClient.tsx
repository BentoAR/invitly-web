...
type PhoneImg = StaticImageData | string;

const STEP_PHONE_CONFIGS: { x: number; y: number; scale: number }[][] = [
  [
    { x: 70,  y: -20, scale: 1.6 },
    { x: -70, y:  20, scale: 1.0 },
  ],
...
export default function HowItWorksClient({
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-y-0 right-0 w-1/2 hidden lg:block overflow-hidden" style={{ zIndex: 2 }} aria-hidden="true">
        {steps.map((_, si) => (
          <div
            key={si}
